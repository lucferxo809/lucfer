...
print(('—'*25)+'\n• XO By @krro6 •\n'+('—'*25))
print('[\033[1;32m✓\033[1;37m] Update Done \033[1;32m✓\ المبرمج LUCFER XO :) ')
...
\x1b[38;5;209m 
 ...
 \033[2;35m❆\033[1;33m═══════════════\033[2;32m[𓆩المـبـࢪمج لوسفر XO𓆪]\033[1;33m════════════════\033[2;35m❆
 \033[1;33m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[2;35m┓    
...
table.add_column("           LUCFER XO        ",style='blue')

table.add_row("1- X+قنـاتي:@LUCFER_XO_AND ",style='yellow')
table.add_row("2- X+حسابي: @krro6",style='purple')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\rXO ¦¦ 𝐕𝐈𝐏-𝐓𝐎𝐎l  {a35}{b}{loop}{a33}•{a31}{len(id)}{a30}  • OK:{a25}{a26}{ok}{a40} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
